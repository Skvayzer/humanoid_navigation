...
struct AlignmentStatusInput
{
  ...
  double correction_rotation_deg{NAN};
  ...
  const AlignmentStatusRuntimeContext & context)
{
  ...
  input.correction_rotation_deg = observation.correction_rotation_deg;
  ...
  const AlignmentStatusDiagnosticInput & input)
{
  ...
  diagnostic_input.correction_rotation_deg = status.correction_rotation_deg;
